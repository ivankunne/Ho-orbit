    ...
    <div className="w-full max-w-7xl mx-auto px-4 lg:px-6 py-10">
      ...
      <div className="flex items-start gap-4 mb-8">
        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-violet-600/20 rounded-2xl flex items-center justify-center shrink-0">
          {tracks.length > 0
            ? <img decoding="async" src={optimizedImage(tracks[0].cover_url || tracks[0].cover, 240)} alt="" className="w-full h-full object-cover rounded-2xl" />
          ...
          {tracks.map((track, i) => (
            ...
            >
              ...
              <div className="relative shrink-0">
                <img decoding="async" loading="lazy" src={optimizedImage(track.cover_url || track.cover, 40)} alt={track.title} className="w-10 h-10 rounded-lg object-cover" />
                <button
