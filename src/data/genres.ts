...
export const FALLBACK_GENRE_GROUPS: GenreGroup[] = [
  {
    ...
    genres: [
      ...
      { name: 'Synth-Pop', color: 'fuchsia' },
      { name: 'Disco', color: 'amber' },
      { name: 'Reggaeton', color: 'orange' },
  ...
  },
  {
    ...
    genres: [
      ...
      { name: 'Metal', color: 'red', sub: ['Heavy Metal', 'Thrash Metal', 'Progressive Metal', 'Death Metal', 'Black Metal', 'Nu-Metal'] },
      { name: 'Grunge', color: 'orange' },
      { name: 'Ska', color: 'lime' },
      { name: 'Rock', color: 'red' },
      { name: 'Pop Rock', color: 'rose' },
      { name: 'Progressive Rock', color: 'violet' },
      { name: 'Psychedelic Rock', color: 'fuchsia' },
      { name: 'Folk Rock', color: 'amber' },
      { name: 'Emo', color: 'rose' },
    ],
  },
  {
    ...
    genres: [
      ...
      { name: 'Ambient', color: 'sky' },
      { name: 'Lo-Fi', color: 'indigo' },
      { name: 'Synthwave', color: 'fuchsia' },
    ],
  },
  {
    label: 'Overig',
