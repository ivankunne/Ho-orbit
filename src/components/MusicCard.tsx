  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-lg aspect-square mb-3">
        ...
        />
        {/* Play affordance is a visual cue, not the click target — the whole
            card is clickable so this still works on touch, where hover never
            fires (see [[mobile-hover-only-controls-bug]] in memory). */}
