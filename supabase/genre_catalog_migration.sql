...
INSERT INTO public.genres (id, label, group_id, parent_id, color, sort_order) VALUES
  ...
  ('synthpop',           'Synth-Pop',         'pop-hip-hop-urban', NULL,      'fuchsia', 14),
  ('disco',              'Disco',             'pop-hip-hop-urban', NULL,      'amber',   15),
  ('reggaeton',          'Reggaeton',         'pop-hip-hop-urban', NULL,      'orange',  16),
  ('k-pop',              'K-Pop',             'pop-hip-hop-urban', NULL,      'pink',    17),
  -- Jazz, Blues & Soul
  ...
  ('rock',               'Rock',              'rock-indie-metal',  NULL,      'red',     15),
  ('pop-rock',           'Pop Rock',          'rock-indie-metal',  NULL,      'rose',    16),
  ('progressive-rock',   'Progressive Rock',  'rock-indie-metal',  NULL,      'violet',  17),
  ('psychedelic-rock',   'Psychedelic Rock',  'rock-indie-metal',  NULL,      'fuchsia', 18),
  ('folk-rock',          'Folk Rock',         'rock-indie-metal',  NULL,      'amber',   19),
  ('emo',                'Emo',               'rock-indie-metal',  NULL,      'rose',    20),
  ('death-metal',        'Death Metal',       'rock-indie-metal',  'metal',   NULL,      21),
  ('black-metal',        'Black Metal',       'rock-indie-metal',  'metal',   NULL,      22),
  ('nu-metal',           'Nu-Metal',          'rock-indie-metal',  'metal',   NULL,      23),
  -- Elektronisch
  ...
  ('ambient',            'Ambient',           'elektronisch',      NULL,      'sky',     20),
  ('lo-fi',              'Lo-Fi',             'elektronisch',      NULL,      'indigo',  21),
  ('synthwave',          'Synthwave',         'elektronisch',      NULL,      'fuchsia', 22),
  -- Overig
